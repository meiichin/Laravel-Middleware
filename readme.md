...
- php artisan migrate
- register user
- you will on url "/home" right now, go to url "/admin"
- tara, middleware reject actived xD 
- you must add field in you db "isAdmin" fill with "1" or that mean is true
- after u add the field in the db, try again to go ur"/admin"
